...
import { FaTwitter, FaInstagram } from 'react-icons/fa'; // Import icons from react-icons library

const Footer = () => {
    return (
        <footer className="w-full fixed bottom-0 bg-white">

            <div className="text-sm text-gray-500 flex justify-center items-center border-t py-3 mx-auto">
                <p>Copyright © 2024</p> 
...
export default Footer;
        ...
        // <footer className="bg-gray-800 text-white px-[350px] flex-shrink-0 py-20 min-h-0">
